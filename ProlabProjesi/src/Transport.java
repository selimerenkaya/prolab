...
public class Transport implements Ireservable {
    ...
    public void HazirBilgileriOlustur() {
        ...
        Bus A_arac_1 = new Bus("Otobüs 1", "Benzin", 10, 20, guzergah_3);
        Bus A_arac_2 = new Bus("Otobüs 2", "Benzin", 10, 15, guzergah_3);
        ...
        Bus B_arac_1 = new Bus("Otobüs 1", "Motorin", 5, 15, guzergah_3);
        Bus B_arac_2 = new Bus("Otobüs 2", "Motorin", 5, 20, guzergah_4);
        // Araç Bilgilerini Tutan ArrayList
        ...
        Bus C_arac_1 = new Bus("Otobüs 1", "Motorin", 6, 20, guzergah_4);
        Airplane C_arac_2 = new Airplane("Uçak 1", "Gaz", 25, 30, guzergah_5);
        Airplane C_arac_3 = new Airplane("Uçak 2", "Gaz", 25, 30, guzergah_5);
        // Araç Bilgilerini Tutan ArrayList
        ...
        Train D_arac_1 = new Train("Tren 1", "Elektrik", 3, 25, guzergah_1);
        Train D_arac_2 = new Train("Tren 2", "Elektrik", 3, 25, guzergah_2);
        Train D_arac_3 = new Train("Tren 3", "Elektrik", 3, 25, guzergah_2);
        // Araç Bilgilerini Tutan ArrayList
        ...
        Airplane F_arac_1 = new Airplane("Uçak 1", "Gaz", 20, 30, guzergah_6);
        Airplane F_arac_2 = new Airplane("Uçak 2", "Gaz", 20, 30, guzergah_6);
        // Araç Bilgilerini Tutan ArrayList
